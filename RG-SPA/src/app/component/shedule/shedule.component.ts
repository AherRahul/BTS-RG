...
export class SheduleComponent implements OnInit {
    ...
    public projectDataSource: Object[] = [
        ...
        { text: 'Rahul Aher', id: 4, color: '#7fa900', HospitalGroupId: 4 },
        { text: 'Beena Jha', id: 5, color: '#df5286', HospitalGroupId: 5 },
        { text: 'Kavin Silvera', id: 6, color: '#7fa900', HospitalGroupId: 6 },
        { text: 'Divya Nair', id: 7, color: '#df5286', HospitalGroupId: 7 },
        { text: 'Prashant Kutty', id: 8, color: '#7fa900', HospitalGroupId: 8 },
    ...
    public categoryDataSource: Object[] = [
        ...
        { text: 'Project-6', id: 6, color: '#df5286', DoctorGroupId: 3, startHour: '06:00', endHour: '12:00' },
        { text: 'Project-7', id: 7, color: '#7fa900', DoctorGroupId: 4, startHour: '06:00', endHour: '12:00' },
        { text: 'Project-8', id: 8, color: '#df5286', DoctorGroupId: 5, startHour: '06:00', endHour: '12:00' },
        ...
        { text: 'Project-11', id: 11, color: '#df5286', DoctorGroupId: 7, startHour: '06:00', endHour: '12:00' },
        { text: 'Project-12', id: 12, color: '#7fa900', DoctorGroupId: 8, startHour: '06:00', endHour: '12:00' },
        { text: 'Project-13', id: 13, color: '#df5286', DoctorGroupId: 9, startHour: '06:00', endHour: '12:00' },
    ];
